...
export default function Dashboard() {
  ...
  // console.log("Profile: ", authState.user?.userId?.profilePicture);

  // useEffect(() => {   longPolling
  //   setInterval(() => {
  //     dispatch(getAllPosts());
  //   }, 900);
  // })
          ...
          <div className={styles.wrapper}>
            ...
            <div className={styles.createPostContainer}>
              ...
              {postContent.length > 0 &&
                <div onClick={handleUpload} value={ fileContent} className={styles.uploadButton}>Post</div>
              }
